<?php
// ===========================================
// SESSION START (WAJIB PALING ATAS, SEKALI)
// ===========================================
session_start([
...
// ===========================================
// H∆M∆H FILEMANAGER - LOGIN CONFIG
// ===========================================
$LOGIN_USER = 'hamah';
$LOGIN_PASS = 'h/\m/\h'; // GANTI PASSWORD
...
if (isset($_POST['login'])) {
    if (
        ...
        $_POST['username'] === $LOGIN_USER &&
        $_POST['password'] === $LOGIN_PASS
    ) {
        $_SESSION['hamah_login'] = true;
        header("Location: ?");
        exit;
    } else {
...
// ===========================================
// LOGIN PAGE (BLOCK TOTAL FILE MANAGER)
// ===========================================
if (!isset($_SESSION['hamah_login'])):
?>
<!DOCTYPE html>
<html>
<head>
<title>H∆M∆H Filemanager - Login</title>
<meta charset="UTF-8">
<style>
body{
    background:#0a0a0a;
...
<a href="?logout" class="button" style="border-color:#ff4444;color:#ff4444;">
    🚪 Logout
</a>
    </div>
</div>
...
<div style="margin-top: 30px; padding: 20px; text-align: center; color: #888; border-top: 1px solid #333;">
    <p>H∆M∆HFilemanager v2.0 | Enhanced with Anti-500, Anti-Blank, Anti-Error Protection</p>
